                ...
                (/^[0-9]+$/.test(link.label)) ?
                  ...
                  (
                    link.label.includes("Previous") ?
                      <a href={link.url} onClick={(e) => { e.preventDefault(); link.url && setPagination(Number(pagination) - 1) }} className={`block relative px-3 py-2 ml-0 leading-tight border ${classes} ${rounded}`}>
